...
function SoilMoistureSensorVariableDepth() {
    ...
    const columnNames = {
        ...
        p3: "Soil Moisture(Level 40cm) %",
        p4: "Soil Temperature(Level 40cm) °C",
        p5: "Soil Moisture(Level 60cm) %",
        p6: "Soil Temperature(Level 60cm) °C",
        createdAt: "Timestamp"
    };
                            ...
                            <Card.Body>
                                ...
                                <Box display="flex" alignItems="center" gap={4} mb={2} mt={2}>
                                    <Box display="flex" alignItems="center" mr={3}>
                                        ...
                                        <Typography variant="body1" component="span">
                                            <strong>Temperature (20cm):</strong> {latestData.p1} °C
                                        </Typography>
                                    </Box>
                                    <Box display="flex" alignItems="center" mr={3}>
                                        <ThermostatIcon color="primary" sx={{ mr: 1 }} />
                                        <Typography variant="body1" component="span">
                                            <strong>Temperature (40cm):</strong> {latestData.p3} °C
                                        </Typography>
                                    </Box>
                                    <Box display="flex" alignItems="center" mr={3}>
                                        <ThermostatIcon color="primary" sx={{ mr: 1 }} />
                                        <Typography variant="body1" component="span">
                                            <strong>Temperature (60cm):</strong> {latestData.p5} °C
                                        </Typography>
                                    </Box>
                                </Box>
                                ...
                                <Box display="flex" alignItems="center" gap={4} mb={2} mt={3}>
                                    <Box display="flex" alignItems="center" mr={3}>
                                        ...
                                        <Typography variant="body1" component="span">
                                            <strong>Soil Moisture (20cm):</strong> {latestData.p2} %
                                        </Typography>
                                    </Box>
                                    <Box display="flex" alignItems="center" mr={3}>
                                        <WaterDropIcon color="primary" sx={{ mr: 1 }} />
                                        <Typography variant="body1" component="span">
                                            <strong>Soil Moisture (40cm):</strong> {latestData.p4} %
                                        </Typography>
                                    </Box>
                                    <Box display="flex" alignItems="center" mr={3} >
                                        <WaterDropIcon color="primary" sx={{ mr: 1 }} />
                                        <Typography variant="body1" component="span">
                                            <strong>Soil Moisture (60cm):</strong> {latestData.p6} %
                                        </Typography>
                                    </Box>
                                </Box>
                            </Card.Body>
